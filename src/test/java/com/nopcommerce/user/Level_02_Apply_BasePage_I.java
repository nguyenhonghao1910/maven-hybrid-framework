 ...
 * = System.getProperty("user.dir"); String Email; //Khai báo BasePage basePage;
 * //BasePage: Class //basePage: Object
 * 
 * @BeforeClass //Multiple browser public void beforeClass() {
 * System.setProperty("webdriver.gecko.driver", projectPath +
 * "\\Browserdrivers\\geckodriver.exe"); driver = new FirefoxDriver(); //Khởi
 * tạo basePage = new BasePage(); driver.manage().timeouts().implicitlyWait(20,
 * TimeUnit.SECONDS); Email = "abc" + nextgenemail() + "@mail.vn" ;
